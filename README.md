...
Because only relative strength (i.e., <img alt="$r_i - r_j$" src="svgs/ee16fa4b829c75efab1d384550fc8f55.png" align="middle" width="46.501125pt" height="19.178279999999994pt"/>) is meaningful for the ratings, you can use `--baseline` flag to specify a team as the baseline of the graph.
